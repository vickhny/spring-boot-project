...
public class SearchExceptionController {
	...
	public ResponseEntity<Object> exception(SearchServiceException exception) {
	...
	public @ResponseBody ExceptionResponse handleInvalidInputException(final Exception exception,
			final HttpServletRequest request) {
